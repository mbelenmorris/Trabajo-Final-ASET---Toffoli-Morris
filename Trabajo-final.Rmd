...
## Tasas básicas del Mercado de trabajo en el período 2019-2023 

*(Los valores nos habían dado diferentes, más consistentes con los que publica el INDEC, no supimos por qué se nos cambiaron)*
...
#### Niveles de precariedad según lugar de nacimiento

Analizando los niveles de precariedad según lugar de nacimiento encontramos que la distribución es similar en general, pero los niveles medio y alto tienen mayor relevancia en el caso de los migrantes de países limítrofes; seis de cada 10 ocupados/as se ubican en alguna de estas categorías.
...
#### Niveles de precariedad según nivel educativo

El entrecruzamiento entre nivel educativo y niveles de precariedad arroja como resultado una relación inversamente proporcional entre ambas variables. Así, siete de cada diez personas que no han completado el nivel primario tienen niveles medios o altos de precariedad; a la vez que dos personas cada diez que completaron el nivel universitario se concentran en esas categorías.
...
#### Niveles de precariedad según ámbito de establecimiento

Si observamos niveles de precariedad según el ámbito del establecimiento, encontramos que para cada uno de esos niveles los valores son más importantes en el ámbito privado que en el ámbito público.
...
Amerita, sin embargo, revisar qué ocurre con cada uno de los tipos de precariedad que identificamos.

Mientras que hay valores en los que asalariados/as del ámbito público y privado se encuentran lejos (precarización en las condiciones de trabajo) hay otros en los que están más cerca (precarización por la intensidad de la jornada laboral, precarización en las formas de contratación).
...
Si indagamos en los trabajadores/as por cuenta propia, quienes se desempeñan en el sector privado, encontramos una mayor incidencia de la precariedad por ingresos en comparación con los asalariados. En los demás tipos de precariedad, también existen diferencias entre ambos grupos de trabajadores/as.
...
#### Niveles de precariedad según sector de actividad

La apertura por sectores de actividad nos permite distinguir un grupo en el que los niveles altos de precariedad superan el 20% del total de ocupados/as: Construcción, Servicio doméstico y Hoteles y restaurantes. Le sigue de cerca el sector Comercio. Los valores más bajos aparecen en la Administración pública y en Enseñanza (donde existe mayor prevalencia del sector público que del privado).

En relación con los niveles medios de precariedad, casi la mitad de los/as ocupados precarios/as de los sectores de Comercio, Construcción, Servicio Doméstico, Hoteles y restaurantes y Otros servicios sociales y comunitarios se encuentran en este grupo.
...
![](Precariedad_por_Sector.png)

Un último ejercicio en relación con los sectores consistió en evaluar cuáles tenían ocupados/as con valor "0" en precariedad_total. Esto arrojó los siguientes resultados:
...
![](Algo_de_Precariedad_por_Sector.png)
